...
class ScoresheetMenuController {
  constructor (configuration, refIdentity, $location, $document, $scope, user, logger) {
    Object.assign(this, { configuration, refIdentity, $location, $document, $scope, user, logger })
...
ScoresheetMenuController.$inject = ['configuration', 'refIdentity', '$location', '$document', '$scope', 'user', 'logger']
