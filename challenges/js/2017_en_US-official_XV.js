{
    ...
    "missions": [{
        ...
        },
        {
            ...
            "score": [function(M07, M02, M06, M13_1, M16_3, M16_4) {
                var availableBigWater = 4;
                if (M02 === 'yes') { availableBigWater++; }
                if (M06 === 'yes') { availableBigWater++; }
                if (M07 === 'yes') { availableBigWater--; }
                if (M13_1 === 'yes') { availableBigWater--; }
                if (M16_4 === 'yes') { availableBigWater--; }
                availableBigWater -= parseInt(M16_3);
                if(availableBigWater < 0) { return new Error("Too many big water models are being used.") }
        ...
        },
        {
            ...
            "score": [function(M13_1, M13_2, M02, M06, M07, M16_3, M16_4) {
                var availableBigWater = 4;
                if (M02 === 'yes') { availableBigWater++; }
                if (M06 === 'yes') { availableBigWater++; }
                if (M07 === 'yes') { availableBigWater--; }
        ...
        },
        {
            ...
            "score": [function(M16_1, M16_2, M16_3, M16_4, M02, M06, M07, M13_1) {
                var availableBigWater = 4;
                if (M02 === 'yes') { availableBigWater++; }
                if (M06 === 'yes') { availableBigWater++; }
                if (M07 === 'yes') { availableBigWater--; }
